...
public class DatabaseTest {
    ...
    public static void selectTest() throws Exception {
        ...
        System.out.println(db.select("*","t2,t1,t4",null));
        System.out.println(db.select("x,z", "t2,t1,t4",null));
        System.out.println(db.select("x+z as T,x-z as Y", "t2,t1,t4","T>9,Y<0"));
    }
